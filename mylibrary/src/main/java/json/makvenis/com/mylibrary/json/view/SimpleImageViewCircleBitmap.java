...
public class SimpleImageViewCircleBitmap extends ImageView {
    ...
    //构造方法，参数上下文
    public SimpleImageViewCircleBitmap(Context context) {
        super(context);
        mContext = context;
    }

    public SimpleImageViewCircleBitmap(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        setCustomAttributes(attrs);
    }

    public SimpleImageViewCircleBitmap(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
