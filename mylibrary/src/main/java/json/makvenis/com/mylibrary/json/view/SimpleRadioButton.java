...
public class SimpleRadioButton extends RadioButton{
    ...
    public SimpleRadioButton(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SimpleRadioButton(Context context, AttributeSet attrs, int defStyle) {
